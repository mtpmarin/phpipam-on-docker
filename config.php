 ...
 ******************************/
$db['host'] = get_env('PHPIPAM_DB_HOST') ?: 'mariadb';
$db['user'] = get_env('PHPIPAM_DB_USER') ?: 'phpipam';
$db['pass'] = get_env('PHPIPAM_DB_PASS') ?: 'phpipam';
$db['name'] = get_env('PHPIPAM_DB_NAME') ?: 'PHPIPAM';
$db['port'] = get_env('PHPIPAM_DB_PORT') ?: 3306;
...
/**
 *  Chave usada para permitir qualquer versão do php ( usada para mais recente )
 */
